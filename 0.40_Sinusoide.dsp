...
// e da richiamare all'occorrenza
...
/* ora bisogna generare la sinusoide partendo dal fasore.
Per creare una sinusoide partendo dal fasore
dobbiamo innanzitutto riscalare questi valori che nel tempo
si muovono tra 0. e 1. (del fasore) affinché si muovano
per un valore espresso in radianti, che ci permette di calcolare una circonferenza, e che sappiamo essere
di 2 volte PI GRECO. 
Il valore di PI GRECO approssimato che useremo è di 3.1415926535897932385
moltiplicato per due è di : 6.2831853071795 */

due_pigreco = 6.2831853071795;

/* ora bisogna creare una funzione per dire al fasore di percorrere
...
che il nostro fasore deve seguire per restituirci un onda sinusoidale */

sinusoide = sin(fasore_pi);

//process sono le 2 uscite per la sinusoide generata

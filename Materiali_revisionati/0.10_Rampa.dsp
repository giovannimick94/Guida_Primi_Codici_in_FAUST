...
Ogni secondo corrisponde ad un tot. di campioni che si susseguono al suo interno:

esempio, ad una frequenza di campionamento di 48000 Hz
...
dobbiamo partire della creazione di un LOOP: 
partendo da un valore definito alla base, 
ad esempio 0.1 dato al primo campione e creando una somma ciclica di questo, ogni campione successivo
viene incrementato del valore impostato rispetto al precedente,(quindi creando un incremento infinito di 0.1).

Ipotizzando una situazione dove ogni campione abbia una durata di 10ms,
arriveremo dopo 10 incrementi al valore di 1: 
...
alla fine di 1 secondo il nostro valore incrementato sarà arrivato a 4800
a 2 secondi 9600, e così via... */

//CODICE:
//process = 0.1 : + ~ _;
//per vedere la rampa sull'oscilloscopio di FAUST:
    process = _; // commentare questo process.
//e avviare il process rimuovendo il commento alla riga sottostante "CODICE:"
